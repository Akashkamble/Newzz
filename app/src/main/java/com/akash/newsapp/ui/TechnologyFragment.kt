...
class TechnologyFragment : androidx.fragment.app.Fragment(),ArticleListAdapter.ItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        articleListAdapter = ArticleListAdapter(this@TechnologyFragment)
